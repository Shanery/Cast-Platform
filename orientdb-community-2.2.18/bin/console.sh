...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.2.18.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="2.2.x@r3e8d46e73aa087fce245fa1125ab7d984a247f6e; 2017-04-06 15:12:17+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.2.18.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
